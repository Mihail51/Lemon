...
<body>
  ...
  <article id="slider_recipees">
  	...
  	<div id="slides_recipe">
  		<div class="content" data-slide="1" style="--bg:url('../img/pexels-photo-104987.jpg');">
  			<div class="foto">
  			...
  			<div class="description">
  				...
  				<p>If you're looking for decadence, look no further — you've found the Holy Grail of desserts...</p>
  				<form action="html/recipe.php" target="_blank" rel="noopener noreferrer">
  					<button type="submit">Get the recipe</button>
  				</form>
  			</div>
  		</div>

  		<div class="content" data-slide="2" style="--bg:url('../img/pexels-photo-176038_1.jpg');">
  			<div class="foto">
  				<img src="img/pexels-photo-176038_1.jpg" alt="">
  			</div>
  			<div class="description">
  				<img src="img/Logo_hero_page.png" alt="Logo" class="herologo">
  		...
  		<div class="content" data-slide="3" style="--bg:url('../img/pexels-photo-218844.jpg');">
  			<div class="foto">
  		...
  		<div class="content" data-slide="4" style="--bg:url('../img/recipe_blog.jpg');">
  			<div class="foto">
  			...
  			<div class="description">
  				...
  				<p>If you're looking for decadence, look no further — you've found the Holy Grail of desserts...</p>
  				<form action="html/recipe.html" target="_blank" rel="noopener noreferrer">
  					<button type="submit">Get the recipe</button>
  				</form>
  			</div>
  		</div>

  		<div class="content" data-slide="5" style="--bg:url('../img/recipe_1.jpg');">
  			<div class="foto">
  	...
  	<div id="controls">
  		<label for="switch1" style="--thumb:url('../img/pexels-photo-104987.jpg');"><span
  				class="color"></span></label>
  		<label for="switch2" style="--thumb:url('../img/pexels-photo-176038_1.jpg');"><span
  				class="color"></span></label>
  		<label for="switch3" style="--thumb:url('../img/pexels-photo-218844.jpg');"><span
  				class="color"></span></label>
  		<label for="switch4" style="--thumb:url('../img/recipe_blog.jpg');"><span class="color"></span></label>
  		<label for="switch5" style="--thumb:url('../img/recipe_1.jpg');"><span class="color"></span></label>
  	</div>
  </article>
  ...
  <!-- HOME SIDEBAR -->
  <div class="layout__columns sidebar_wrap">
  	<!-- ЛЕВЫЙ САЙДБАР -->
  	<aside class="sidebar_left">
  		...
  		<div class="client-wrap">
  			...
  			<div class="buttons">
  				...
  				<div class="btn sign_in_btn" id="sign_in_btn"><a href="#signinwindow" id="sign_in_close">sign_in</a>
  				</div>
  			</div>
  			<div id="loginwindow" class="window">
  				<aside class="login" id="log_in">
  					<div class="header_client">
  						<p>Login</p>
  						<a class="cansel" href="#top"><img src="img/cancel.png" alt=""></a>
  					</div>
  					<section class="content_login">
  						<form action="/login" method="post">
  							...
  							<input type="checkbox" name="remember" id="rem" value="Remember me"><span>Remember
  								me</span>
  		...
  		<!-- Featured Recipe -->
  		<article class="featured-recipe featured-recipe--dark">
  			<h3 class="featured-recipe__title">Popular Now</h3>

  			<p class="featured-recipe__headline">Vanilla Frozen Coffee</p>

  			<p class="featured-recipe__description">
  			...
  			<div class="featured-recipe__meta">
  				<form class="featured-recipe__form" action="html/recipe.html" target="_blank" rel="noopener noreferrer">
  					<button class="featured-recipe__button">get it recipe</button>
  				</form>

  				<div class="featured-recipe__icons">
  					<p class="featured-recipe__time">6 mins</p>
  					<p class="featured-recipe__comments">240</p>
  					<p class="featured-recipe__views">400</p>
  				</div>
  			</div>
  		</article>
  	</aside>
  				...
  				<div class="author_info_wrap">
  					...
  					<div class="author_info">
  						...
  						<div class="author_description_wrap">
  							<h4>About Lemon</h4>
  							<p class="author_description">Over the fifteen-year life span of Food.com, we’ve learned
  								that
  								– in
  								addition to eating – sharing is what you do best. And thanks to the 20 million of you
  								who
  								come here
  								each month, we now have 500,000 recipes to show for it, more than anywhere else in the
  								digital
  								universe. We also have tons crazy-tempting photos, troves of recipe reviews and more
  								than
  								2 million
  			...
  			<div class="recipes_wrap">
  				...
  				<div class="slider_recipes_wrap">
  					...
  					<div class="slide_recipe slide-one">
  						...
  						<form action="html/quick_and_easy.html" target="_blank" rel="noopener noreferrer">
  					...
  					<div class="slide_recipe slide-two">
  						...
  						<form action="html/middle.html" target="_blank" rel="noopener noreferrer">
  							<button>view more</button>
  						</form>
  					</div>
  					...
  					<div class="slide_recipe slide-three">
  						...
  						<form action="html/long.html" target="_blank" rel="noopener noreferrer">
  							<button>view more</button>
  						</form>
  					</div>
  				</div>
  			...
  			<div class="timeline_content">
  				...
  				<div class="timeline_graf">
  					...
  					<div class="timeline_item">
  						<span class="timeline_label">EASY</span>
  						<span class="timeline_time">15 mins</span>
  						<div class="timeline_bar bar-easy"></div>
  					</div>

  					<!-- MIDDLE -->
  					<div class="timeline_item">
  						<span class="timeline_label">MIDDLE</span>
  						<span class="timeline_time">25 mins</span>
  						<div class="timeline_bar bar-middle"></div>
  					</div>

  					<!-- LONG -->
  					<div class="timeline_item">
  						<span class="timeline_label">LONG</span>
  						<span class="timeline_time">40 mins</span>
  						<div class="timeline_bar bar-long"></div>
  					</div>
